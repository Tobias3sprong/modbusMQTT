...
def resetVoltage():
    try:
        modbusclient.write_registers(int(0x2700), int(0x5AA5), unit=1)
        modbusclient.write_registers(int(0x2400), int(0x14), unit=1)
...
def resetCurrent():
    try:
        modbusclient.write_registers(int(0x2700), int(0x5AA5), unit=1)
        modbusclient.write_registers(int(0x2400), int(0xA), unit=1)
    except Exception as e:
